          ...
          <div>
            ...
            <Reveal delay={0.2}>
              <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground">
                Sales velocity, resale queue, gate activity, payout calendar —
                all in one workspace. Built for the operator running
                tonight&apos;s door, not just analyzing last quarter.
              </p>
            </Reveal>
            <Reveal delay={0.3}>
              <Link
...
function FullDashboardMock() {
  ...
  return (
     ...
     */
    <div
      className="relative lg:-mr-16 xl:-mr-32 2xl:-mr-48"
      role="img"
      aria-label="Miso operator dashboard preview"
    >
      {/*
       ...
       */}
      <div className="glass-top-highlight overflow-hidden rounded-lg border border-hairline-strong bg-ink-elevated shadow-[0_40px_120px_-40px_rgba(0,0,0,0.8)]">
        {/* App chrome titlebar */}
          ...
          <div className="min-w-[560px] md:min-w-0">
            ...
            <div className="grid grid-cols-4 gap-px bg-hairline">
              {KPIS.map((kpi) => (
                <div
                  key={kpi.label}
                  className="snap-start bg-ink-elevated px-4 py-5"
                >
