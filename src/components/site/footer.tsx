        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_repeat(4,1fr)] md:gap-10">
          <div className="space-y-5">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Ticketing infrastructure for venues, festivals, and cultural
              collectives. One workspace per organization — branded storefront,
              Stripe payouts, anti-scalping resale.
            </p>
