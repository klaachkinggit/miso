        ...
        <div className="grain flex h-full w-full flex-col justify-between px-10 py-14">
          <div>
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Every organization gets its own Stripe Connect account, its own
              storefront, its own resale exchange. Your audience, your data,
              your payouts.
            </p>
          </div>
          ...
          <dl className="grid gap-px overflow-hidden rounded-md border border-hairline bg-hairline">
            {PROOF.map((row) => (
              ...
              >
                ...
                <dd className="display text-2xl text-foreground">
                  {row.metric}
                </dd>
              </div>
            ))}
