...
export function PurchaseReceipt(props: PurchaseReceiptProps) {
  ...
  return (
    ...
    >
      <Paragraph>
        Thanks for your purchase. Your {props.quantity > 1 ? `${props.quantity} ` : ""}
        {plural} for <strong>{props.eventName}</strong> {props.quantity > 1 ? "have" : "has"} been
      ...
      <Paragraph>
        Your {plural} live in your wallet — open them anytime to view the QR code for entry.
      </Paragraph>
      <Button
