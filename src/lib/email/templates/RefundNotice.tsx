...
export function RefundNotice(props: RefundNoticeProps) {
  return (
    ...
    >
      <Paragraph>
        A refund has been issued for your <strong>{props.eventName}</strong>{" "}
        purchase.
      </Paragraph>
      <Section style={{ margin: "0 0 18px" }}>
        ...
        {props.reason ? (
          <DetailRow label="Reason" value={props.reason} />
        ) : null}
      </Section>
      <Paragraph>
        The refund will appear on your original payment method within a few
        business days, subject to your bank&apos;s processing times.
      </Paragraph>
    </Layout>
  );
}
