...
export function ResaleSoldNotice(props: ResaleSoldNoticeProps) {
  return (
    ...
    >
      <Paragraph>
        Good news — your resale listing for <strong>{props.eventName}</strong>{" "}
        has sold.
      </Paragraph>
      ...
      <Paragraph>
        Your payout (listing price net of the marketplace fee and any organizer
        royalty) is on its way to your connected Stripe account. Payout timing
        follows your Stripe payout schedule.
      </Paragraph>
    </Layout>
  );
}
