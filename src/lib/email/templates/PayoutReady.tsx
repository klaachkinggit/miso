...
export function PayoutReady(props: PayoutReadyProps) {
  return (
    ...
    >
      <Paragraph>
        Your Stripe onboarding is complete and your account can now accept charges and receive
        payouts.
      </Paragraph>
      <Paragraph>
        You can publish events and start selling tickets. Proceeds settle to your connected Stripe
        account on your payout schedule.
      </Paragraph>
      <Button
