...
export function normalizeOrganizationBranding(value: unknown): OrganizationBranding {
  ...
  const parsed = OrganizationBrandingSchema.safeParse({
    tagline: cleanOptionalString(typeof raw.tagline === "string" ? raw.tagline : null),
    accent_color: cleanOptionalString(typeof raw.accent_color === "string" ? raw.accent_color : null),
    logo_url: cleanOptionalString(typeof raw.logo_url === "string" ? raw.logo_url : null),
    hero_image_url: cleanOptionalString(typeof raw.hero_image_url === "string" ? raw.hero_image_url : null),
  });
