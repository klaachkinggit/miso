    ...
    return (
      <div className="container flex min-h-[60vh] items-center justify-center py-16">
        <div className="w-full max-w-md rounded-md border border-hairline bg-ink-raised/40 p-10 text-center">
          ...
          <h1 className="display text-2xl text-foreground">You&apos;re unsubscribed</h1>
          <p className="mx-auto mt-3 max-w-sm text-sm text-muted-foreground">
            You will no longer receive announcements from this organizer. You can follow them again
            any time from their storefront.
          </p>
          <Link
            href="/events"
