    ...
    <form action={organizerSignupAction} className="grid gap-6">
      <div>
        ...
        <p className="mt-4 text-sm leading-6 text-muted-foreground">
          Tell us about your business. Next we&apos;ll hook up Stripe Connect, then publish your first event.
        </p>
      </div>
      {error ? (
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <FieldWithIcon icon={UserRound} label="Your name" name="display_name" required autoComplete="name" />
        <FieldWithIcon icon={Building2} label="Organization name" name="organization_name" required />
      </div>

      <FieldWithIcon icon={Mail} label="Work email" name="email" type="email" autoComplete="email" required />
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-xs text-muted-foreground">ISO 3166-1 alpha-2 (FR, DE, MA…).</p>
        </div>
      </div>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/signup/buyer" className="font-medium text-signal hover:underline">
          Buyer signup
        </Link>
      </p>
    </form>
