    ...
    <AuthShell>
      <div className="grid gap-6">
        <div>
          ...
          <h1 className="display mt-4 text-4xl text-foreground md:text-5xl">Join MISO.</h1>
          <p className="mt-4 text-sm leading-6 text-muted-foreground">
            Organizers build a workspace with Stripe payouts and a branded storefront. Buyers grab
            tickets in seconds.
          </p>
        </div>
        <Link
        ...
        >
          <span aria-hidden className="absolute -left-px top-6 h-10 w-[2px] bg-signal" />
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-baseline justify-between gap-3">
              <h2 className="text-lg font-medium text-foreground">Create your organization</h2>
              <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-signal">
                Recommended
              </span>
            </div>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Launch a branded ticketing page, take payouts through Stripe Connect, manage team and
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Pick up event tickets, keep them in your account, resell at face value through the
              official exchange.
            </p>
          </div>
