    ...
    <AuthShell>
      <div className="grid gap-6">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Pick how you&apos;ll use MISO</h1>
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            Buyers grab tickets in seconds. Organizers get a Stripe-powered ticketing workspace.
          </p>
        </div>
        <Link
          href="/signup/buyer"
