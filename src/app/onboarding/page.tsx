    ...
    <div className="container max-w-5xl py-10">
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          Buyer accounts go straight to event discovery. Organizer accounts
          enter a sandbox Smartboard, then unlock publishing after legal and
          Stripe verification.
        </p>
      </div>
          ...
          <CardContent className="grid gap-5 p-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Browse tickets, manage your wallet, and use the official resale
                exchange.
              </p>
            </div>
          ...
          <CardContent className="grid gap-6 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Create draft events immediately. Publishing stays locked until
                  legal identity and Stripe Connect are verified.
                </p>
              </div>
            </div>
