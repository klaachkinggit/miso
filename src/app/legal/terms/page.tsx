...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        By using MISO you agree to purchase, hold, and resell tickets only
        within the limits set by the event organizer and applicable law. Tickets
        are non-refundable except as required by law or explicitly offered
        through the official resale exchange.
      </p>
    </>
  );
}
