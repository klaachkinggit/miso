        ...
        <CardContent className="grid gap-5">
          <div className="grid gap-3 rounded-md border border-border/70 p-4 text-sm">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <Badge
                variant={seller?.charges_enabled ? "success" : "secondary"}
              >
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <Badge
                variant={seller?.payouts_enabled ? "success" : "secondary"}
              >
          ...
          <p className="text-sm leading-6 text-muted-foreground">
            Resale payouts are handled through Stripe Connect. Complete this
            once before listing a paid ticket on the exchange.
          </p>
