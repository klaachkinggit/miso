        ...
        <div className="grid gap-5">
          ...
          <div className="grid gap-2 sm:max-w-xs">
            ...
            <p className="text-xs text-muted-foreground">
              500 = 5%. Set 0 or disable for no royalty.
            </p>
          </div>
        </div>
      </Panel>
    ...
    <div className="grid gap-5">
      ...
      <section className="rounded-md border border-destructive/40 bg-destructive/[0.04]">
        <header className="border-b border-destructive/30 px-6 py-5">
          ...
          <h2 className="display mt-2 text-2xl text-destructive">
            Delete organization.
          </h2>
          <p className="mt-2 max-w-xl text-sm text-muted-foreground">
            Delete only empty organizations. Stripe accounts, events, purchases,
            customers, or listings block deletion.
          </p>
        </header>
        <form
