...
export type CustomDomainActionResult =
  | { ok: true; domain: string; token: string; txtRecordName: string; verified?: boolean }
...
export async function setCustomDomainAction(formData: FormData): Promise<CustomDomainActionResult> {
