---
description: Build a system map before touching unfamiliar code
allowed-tools: Read, Glob, Grep, Bash
argument-hint: <area, file, or feature to understand>
---

Before touching $ARGUMENTS, build a system map. Do not make changes until map is confirmed.

1. **Entry points** — How does control/data enter this area? (routes, events, CLI commands)
2. **Dependencies** — What does this code import? What imports this code? (`grep -r "import.*$ARGUMENTS"`)
