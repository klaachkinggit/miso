---
description: Exhaustive requirements interview before any implementation
allowed-tools: Read, Glob, Grep
argument-hint: <feature or task description>
---

Before writing any code for $ARGUMENTS, conduct an exhaustive requirements interview.
