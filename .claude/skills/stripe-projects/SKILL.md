...
### Step 6: Continue with the Stripe Projects CLI

After the project is initialized, continue with `stripe projects add ... --json --yes` for the selected service. Print the returned environment variable names in a table, but never their values.
