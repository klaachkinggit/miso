...
- **Parallel builders**: only on disjoint file sets, tell each to ignore others' typecheck errors, and run a verify stage after. Anything touching `src/lib/stripe-marketplace/` core: sequential pipeline and high-risk review.
