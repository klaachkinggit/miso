...
- Slice 6: Organization admins can edit public storefront branding from `/admin/settings`. Branding lives in `organizations.branding` and currently includes tagline, accent color, logo, and storefront hero image.
